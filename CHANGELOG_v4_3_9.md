...
- Deepened Shaam–Brabant node registry with archival routes, people and family tracking without changing the research tree.
- Added archive series: Alphen–Chaam schepenbank, vestbrieven, DTB, armmeesters, appeals and property chains.
- Fixed Arabic/RTL entry freeze with fail-safe and direct language query handoff.
