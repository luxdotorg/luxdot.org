(()=>{if(!document.querySelector('link[data-lux-cleanup]')){const l=document.createElement('link');l.rel='stylesheet';l.href=(location.pathname.includes('/prophets/')?'../':'')+'luxdot-cleanup-v41814.css?v=41814';l.dataset.luxCleanup='1';document.head.appendChild(l)}})();
...
function ensureStyle(){if(!d.getElementById('lux43113-header-style')){let l=d.createElement('link');l.id='lux43113-header-style';l.rel='stylesheet';l.href=rootHref('luxdot-header-v43108.css?v=41840');d.head.appendChild(l)}if(!d.getElementById('lux41832-signal-style')){let l=d.createElement('link');l.id='lux41832-signal-style';l.rel='stylesheet';l.href=rootHref('luxdot-signal-header-v41832.css?v=41840');d.head.appendChild(l)}if(!d.getElementById('lux41840-bi-style')){let l=d.createElement('link');l.id='lux41840-bi-style';l.rel='stylesheet';l.href=rootHref('luxdot-bilingual-v41840.css?v=41840');d.head.appendChild(l)}if(!d.getElementById('lux41827-cosmic-style')){let c=d.createElement('link');c.id='lux41827-cosmic-style';c.rel='stylesheet';c.href=rootHref('luxdot-cosmic-site-v41827.css?v=41827');d.head.appendChild(c)}}
...
(()=>{if(document.querySelector('script[data-lux-bilingual]'))return;const here=document.currentScript&&document.currentScript.src;const s=document.createElement('script');s.src=new URL('luxdot-bilingual-v41840.js?v=41840',here||location.href).href;s.defer=true;s.dataset.luxBilingual='1';document.head.appendChild(s)})();
...
(function(){
 try{
  if(!document.querySelector('link[href*="luxdot-symbol-ui.css"]')){
   const l=document.createElement('link');l.rel='stylesheet';l.href='luxdot-symbol-ui.css?v=4184';document.head.appendChild(l);
  }
  if(!document.querySelector('script[src*="luxdot-symbol-ui.js"]')){
   const sc=document.createElement('script');sc.src='luxdot-symbol-ui.js?v=4184';sc.defer=true;document.head.appendChild(sc);
  }
