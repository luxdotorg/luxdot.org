...
(function(){
 try{
  if(!document.querySelector('link[href*="luxdot-symbol-ui.css"]')){
   const l=document.createElement('link');l.rel='stylesheet';l.href='luxdot-symbol-ui.css?v=4183';document.head.appendChild(l);
  }
  if(!document.querySelector('script[src*="luxdot-symbol-ui.js"]')){
   const sc=document.createElement('script');sc.src='luxdot-symbol-ui.js?v=4183';sc.defer=true;document.head.appendChild(sc);
  }
