...
const lang=()=>{const q=new URLSearchParams(location.search).get('lang');if(['ar','en','nl','id','jv','he'].includes(q))return q;const raw=localStorage.getItem('luxdot.lang');return raw==='id'?'id':(window.LuxLang?.get?.()||'en')};
