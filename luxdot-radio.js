(()=>{
 ...
 window.LuxDotRadio={TRACKS,QURAN,JEWISH_SABBATH,CHRISTIAN_SUNDAY,SPIRITUAL_LIBRARY,live,next24,week,audio,toggle,sync,playHourlyIdent,identLang,getStatus:()=>status};
