...
const NAV={
ar:{home:'الرئيسية',library:'المكتبة',faith:'الإيمان والحكمة',nusantara:'نوسانتارا',memory:'الذاكرة',research:'الأبحاث',media:'ميديا / أخبار',projects:'المشاريع'},
en:{home:'Home',library:'Library',faith:'Faith & Wisdom',nusantara:'Nusantara',memory:'Memory',research:'Research',media:'Media / News',projects:'Projects'},
nl:{home:'Home',library:'Bibliotheek',faith:'Geloof & wijsheid',nusantara:'Nusantara',memory:'Geheugen',research:'Onderzoek',media:'Media / Nieuws',projects:'Projecten'},
he:{home:'ראשי',library:'ספרייה',faith:'אמונה וחכמה',nusantara:'נוסנטרה',memory:'זיכרון',research:'מחקר',media:'מדיה / חדשות',projects:'פרויקטים'},
jv:{home:'Ngarep',library:'Pustaka',faith:'Iman & Kawicaksanan',nusantara:'Nusantara',memory:'Pangeling',research:'Panaliten',media:'Media / Pawarta',projects:'Proyèk'},
id:{home:'Beranda',library:'Perpustakaan',faith:'Iman & Kebijaksanaan',nusantara:'Nusantara',memory:'Memori',research:'Riset',media:'Media / Berita',projects:'Proyek'},
fr:{home:'Accueil',library:'Bibliothèque',faith:'Foi & sagesse',nusantara:'Nusantara',memory:'Mémoire',research:'Recherches',media:'Médias / Actualités',projects:'Projets'},
es:{home:'Inicio',library:'Biblioteca',faith:'Fe y sabiduría',nusantara:'Nusantara',memory:'Memoria',research:'Investigación',media:'Medios / Noticias',projects:'Proyectos'},
de:{home:'Start',library:'Bibliothek',faith:'Glaube & Weisheit',nusantara:'Nusantara',memory:'Erinnerung',research:'Forschung',media:'Medien / Nachrichten',projects:'Projekte'},
tr:{home:'Ana sayfa',library:'Kütüphane',faith:'İnanç & Bilgelik',nusantara:'Nusantara',memory:'Hafıza',research:'Araştırma',media:'Medya / Haberler',projects:'Projeler'}
};
