...
window.LuxLang={get:current,set,navigate,names:NAME,dir:DIR,nav:NAV,defaultLang:DEFAULT};document.addEventListener('DOMContentLoaded',init);document.addEventListener('luxlang',()=>setTimeout(init,0));})();