(()=>{"use strict";
const C=document.getElementById('matrix'),x=C.getContext('2d'),signals=document.getElementById('signals'),beliefStars=document.getElementById('beliefStars'),enter=document.getElementById('enter'),sound=document.getElementById('sound'),sub=document.getElementById('sub'),eyebrow=document.getElementById('eyebrow'),micro=document.getElementById('micro'),burst=document.getElementById('burst'),statusA=document.getElementById('statusA'),statusB=document.getElementById('statusB');
